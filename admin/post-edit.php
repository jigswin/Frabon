...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Post Edit</title>
                        ...
                        <div class="col-lg-12">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <?php 
                                        $query = mysqli_query($con, "SELECT * FROM `blog` WHERE blog_id = '{$_GET['id']}' ");
                            ...
                            <button id="update" class="btn btn-primary kTJ5C" style="width:130px">Save Post</button>
                        </div>
                    </div>
                </div>
            </div>
