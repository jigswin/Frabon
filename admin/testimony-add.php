...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Testimony Add</title>
            ...
            <div class="layout-px-spacing">    
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3 class="float-left">Add Testimony</h3>
                    </div>
                </div>
                ...
                <div class="account-settings-container layout-top-spacing">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="desc" class="form-control mb-4 S5hPk" id="desc" placeholder="Enter Description" rows="3"></textarea>
                                                                            <div class="LMNEu OT150 d-none"></div>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button id="add" class="btn btn-dark">Add Testimony</button>
                        </div>
