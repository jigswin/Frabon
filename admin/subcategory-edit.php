...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - sub Category Edit</title>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                                                            <div class="">
                                                                ...
                                                                <?php 
                                                                    $query = mysqli_query($con, "SELECT * FROM `sub_category` where id = '".$_GET['id']."' ");
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <label for="role" class="dob-input">Category</label>
                                                                        <div class="d-block">
                                                                            <div class="form-group mr-1">
                                                                                <select class="form-control mb-4 S5hPk" id="cat_id" placeholder="Select Role">
                                                                    ...
                                                                    <div id="fuSingleFile" class="col-lg-12 layout-spacing">
                                                                        <div class="statbox widget box box-shadow">
                                                                            ...
                                                                            <div class="custom-file-container" data-upload-id="image1">
                                                                                    <label>Upload Images (Allow Single, Size 600 * 300) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                                                                                    ...
                                                                                    <div class="preview-wrap">
                                                                                        <div class="old-image-preview">
                                                                                            <div class="c-image">Current Image</div>
                                                                                            <img class="preview-img" src="images/sub category/<?php echo $row['image'] ?>" >
                                                                                        </div>
                                                                                        <div class="custom-file-container__image-preview" id="iFfxy"></div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="custom-file-container mt-3" data-upload-id="image2">
                                                                                    <label>Upload Banner Images (Allow Single, Size 1000 * 200) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                                                                                    <label class="custom-file-container__custom-file" >
                                                                                        <input type="file" class="custom-file-container__custom-file__custom-file-input" multiple accept="image/x-png,image/gif,image/jpeg">
                                                                                        <input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
                                                                                        <span class="custom-file-container__custom-file__custom-file-control"></span>
                                                                                    ...
                                                                                    <div class="preview-wrap">
                                                                                        <div class="old-image-preview">
                                                                                            <div class="c-image">Current Image</div>
                                                                                            <img class="preview-img" src="images/sub category/<?php echo $row['banner'] ?>" >
                                                                                        </div>
                                                                                        <div class="custom-file-container__image-preview" id="yxfFi"></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
