...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Video Edit</title>
            ...
            <div class="layout-px-spacing">    
                ...
                <div class="page-header">
                    <div class="page-title w-100">
                        ...
                        <a class="btn btn-primary float-right" href="video">Video List</a>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mt-4">
                                                            <div class="form">
                                                                ...
                                                                <?php 
                                                                    $query = mysqli_query($con, "SELECT * FROM `video` where id = '".$_GET['id']."' ");
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="link" class="form-control mb-4 S5hPk" id="link" placeholder="Enter Youtube Link" value="<?php echo $row['link'] ?>">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <label for="link">Current Video</label><br>
                                                                            <object height="120px" data="http://www.youtube.com/v/<?php echo $link[sizeof($link)-1]; ?>"
                                                                            type="application/x-shockwave-flash">
                                                                            <param name="src" value="http://www.youtube.com/v/<?php echo $link[1]; ?>" /></object>
                                                                        </div> 
                                                                    </div> 
