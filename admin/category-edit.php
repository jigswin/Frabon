...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Category Edit</title>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mt-4">
                                                            <div class="">
                                                                ...
                                                                <?php 
                                                                    $query = mysqli_query($con, "SELECT * FROM `category` where id = '".$_GET['id']."' ");
                                                                                ...
                                                                                <div class="custom-file-container" data-upload-id="image">
                                                                                    ...
                                                                                    <div class="preview-wrap">
                                                                                        <div class="old-image-preview">
                                                                                            ...
                                                                                            <img class="preview-img" src="images/category/<?php echo $row['image'] ?>" >
                                                                                        </div>
