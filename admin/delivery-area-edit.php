...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Delivery Area Edit</title>
            ...
            <div class="layout-px-spacing">    
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3 class="float-left">Edit Delivery Area</h3>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                                                            <div class="form">
                                                                ...
                                                                <?php 
                                                                    $query = mysqli_query($con, "SELECT * FROM `delivery_area` where id = '".$_GET['id']."' ");
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4 S5hPk" id="pincode" placeholder="Enter Pincode" value="<?php echo $row['pincode'] ?>">
                                                                            <div class="LMNEu OT150 d-none"></div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
