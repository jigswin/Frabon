...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - LOG</title>
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    ?>
                                        <tr class="OZ6VQ">
                                            ...
                                            <td><?php if($row['image'] != '') { ?><a href="images/banner/<?php echo $row['image'] ?>" target="_blank"><img src="images/banner/<?php echo $row['image'] ?>" height="50"></a><?php } ?></td>
