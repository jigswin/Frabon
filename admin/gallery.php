...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Gallery</title>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title w-100">
                        ...
                        <a class="btn btn-primary float-right" href="gallery-add">Add Images</a>
                                ...
                                <div class="mb-4 style-1">
                                    <table id="style-1" class="table style-1 table-hover non-hover table-responsive">
                                        ...
                                        <tbody>
                                         ...
                                         <?php
                                            $i = 0;
                                            $query = mysqli_query($con, "SELECT * FROM `gallery` ORDER BY position ");
                                            while($row = mysqli_fetch_assoc($query)){ $i++;
                                        ?>
                                            <tr class="OZ6VQ" data-id="<?php echo $row['id'] ?>">
                                                <td></td>
                                                <td class="TGxlg"><?php echo $i ?></td>
                                                <td><a target="_blank" href="images/gallery/<?php echo $row['image'] ?>"><img src="images/gallery/<?php echo $row['image'] ?>" height="100"></a></td>
