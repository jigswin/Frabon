...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Testimony Edit</title>
...
<body class="alt-menu sidebar-noneoverflow">
            ...
            <div class="layout-px-spacing">    
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3 class="float-left">Edit Testimony</h3>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mt-4">
                                                            <div class="">
                                                                ...
                                                                <?php 
                                                                    $query = mysqli_query($con, "SELECT * FROM `testimony` where id = '".$_GET['id']."' ");
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="desc" class="form-control mb-4 S5hPk" id="desc" placeholder="Enter Description" rows="3"><?php echo $row['description'] ?></textarea>
                                                                            <div class="LMNEu OT150 d-none"></div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="fuSingleFile" class="col-lg-12 layout-spacing">
                                                                        <div class="statbox widget box box-shadow">
                                                                            ...
                                                                            <div class="custom-file-container" data-upload-id="image">
                                                                                <label>Upload (Allow Single) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                                                                                ...
                                                                                <div class="preview-wrap">
                                                                                    <div class="old-image-preview">
                                                                                        ...
                                                                                        <img class="preview-img" src="images/testimony/<?php echo $row['image'] ?>" >
                                                                                    </div>
    ...
    <script src="assets/js/pages/testimony.js"></script>
