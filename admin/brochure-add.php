...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Brochure Add</title>
            ...
            <div class="layout-px-spacing">    
                ...
                <div class="page-header">
                    <div class="page-title w-100">
                        <h3 class="float-left">Add Brochure</h3>
                ...
                <div class="account-settings-container layout-top-spacing">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="file" name="file" class="form-control mb-4 S5hPk" id="file" placeholder="Select File" accept="application/pdf">
                                                                            <div class="LMNEu OT150 d-none"></div>
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button id="add" class="btn btn-dark">Add Brochure</button>
                        </div>
