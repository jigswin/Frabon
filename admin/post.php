...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Post</title>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title w-100">
                        ...
                        <a class="btn btn-primary float-right" href="post-add">Create Post</a>
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="mb-4 style-1">
                                    <table id="style-1" class="table style-1 table-hover non-hover table-responsive">
                                        ...
                                        <?php
                                            $i = 0;
                                            $query = mysqli_query($con, "SELECT * FROM `blog` ORDER BY position ");
                                            while($row = mysqli_fetch_assoc($query)){ $i++;
                                        ?>
                                            <tr class="OZ6VQ" data-id="<?php echo $row['blog_id'] ?>">
                                                <td></td>
                                                <td class="TGxlg"><?php echo $i ?></td>
                                                <td class="PSslg"><?php echo $row['content'] ?></td>
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        ...
                                                        <li><a href="post-edit?id=<?php echo $row['blog_id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
