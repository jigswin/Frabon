...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Service Edit</title>
                    ...
                    ?>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control mb-4 S5hPk" id="name" placeholder="Enter Service Name" value="<?php echo $row['name']; ?>">
                        ...
                        <div class="col-lg-12">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="tmp-code d-none"><?php echo $row['text']; ?></div>
                                </div>
                            </div>
                            <button id="edit" class="btn btn-primary kTJ5C">Save</button>
                        </div>
                    </div>
                </div>
            </div>
