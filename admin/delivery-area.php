...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Delivery Area</title>
...
<body class="alt-menu sidebar-noneoverflow">
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title w-100">
                        <h3 class="float-left">Delivery Area</h3>
                        <a class="btn btn-primary float-right" href="delivery-area-add">Add Delivery Area</a>
                    </div>
                </div>
                                            ...
                                            <tr class="OZ6VQ" data-id="<?php echo $row['id'] ?>">
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        ...
                                                        <li><a href="delivery-area-edit?id=<?php echo $row['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
    ...
    <script src="assets/js/pages/delivery-area.js"></script>
