            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Appointment <?php echo ucfirst($_GET['e']) ?></h3>
                    </div>
                </div>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    if($_GET["sdate"] && $_GET["edate"]) {
                                        ...
                                        $query = mysqli_query($con, "SELECT * FROM `appointment` where date between '{$sdate}' and '{$edate}' ORDER BY date DESC ");
                                    }
                                    else {
                                        $query = mysqli_query($con, "SELECT * FROM `appointment` ORDER BY date DESC, time DESC ");
                                    }
