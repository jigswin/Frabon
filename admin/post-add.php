...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Post Add</title>
                        ...
                        <div class="col-lg-12">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <div id="editor-container" class="S5hPk">
                                    </div>
                                </div>
                            </div>
                            <button id="add" class="btn btn-primary kTJ5C" style="width:130px">Create Post</button>
                        </div>
                    </div>
                </div>
            </div>
