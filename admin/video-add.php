...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Video Add</title>
                ...
                <div class="account-settings-container layout-top-spacing">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="link" class="form-control mb-4 S5hPk" id="link" placeholder="Enter Youtube Link">
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button id="add" class="btn btn-dark">Add Video</button>
                        </div>
