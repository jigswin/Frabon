...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Delivery Boy</title>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title w-100 d-flex flex-wrap justify-content-end">
                        <h3 class="float-left w-100 mb-3">Delivery Boy</h3>
                        <a class="btn btn-primary float-right mr-2 mb-2" href="delivery-boy-add">Add Delivery Boy</a>
                                    ...
                                    <table id="style-1" class="table style-1 table-hover non-hover table-responsive">
                                        ...
                                        ?>
                                            <tr class="OZ6VQ" data-id="<?php echo $row['id'] ?>">
                                                ...
                                                <td><a href="images/profile/<?php echo $row['profile_pic'] ?>" target="_blank"><img src="images/profile/<?php echo $row['profile_pic'] ?>" width="60" height="60" style="border-radius: 50%;"></a></td>
                                                <td><a class="btn btn-primary mr-2 mb-2" style="width: 160px;" target="_blank" href="delivery?dboy=<?php echo $row['id'] ?>">Check Delivery</a></td>
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        ...
                                                        <li><a href="delivery-boy-edit?id=<?php echo $row['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
