...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Role Add</title>
                ...
                <div class="account-settings-container layout-top-spacing">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="name" class="form-control mb-4 S5hPk" id="name" placeholder="Enter Role Name">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            foreach ($accessArray[0] as $key => $name) { ?>
                                                                                ...
                                                                                <div class="OB1JT"><?php echo $name ?>
                                                                                    <input type="checkbox" class="k7It4" value="<?php echo $accessArray[1][$key] ?>">
                                                                                </div>  
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button id="add" class="btn btn-dark">Add Role</button>
                        </div>
