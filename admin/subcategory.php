...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Sub Category</title>
            ...
            <div class="layout-px-spacing">
                ...
                <div class="page-header">
                    <div class="page-title w-100">
                        <h3 class="float-left">Sub Category</h3>
                        <a class="btn btn-primary float-right" href="subcategory-add">Add Sub Category</a>
                    </div>
                </div>
                                    ...
                                    <table id="style-1" class="table style-1 table-hover non-hover table-responsive">
                                        ...
                                        <?php
                                            ...
                                            while($row = mysqli_fetch_assoc($query)){ $i++;
                                                ...
                                                $query1 = mysqli_query($con, "SELECT * FROM `category` WHERE id = '{$row['cat_id']}' ");
                                        ...
                                        ?>
                                            <tr class="OZ6VQ" data-id="<?php echo $row['id'] ?>">
                                                ...
                                                <td><a href="images/sub category/<?php echo $row['image'] ?>" target="_blank"><img src="images/sub category/<?php echo $row['image'] ?>" width="100"></a></td>
                                                <td><?php if($row['banner'] != '') { ?><a href="images/sub category/<?php echo $row['banner'] ?>" target="_blank"><img src="images/sub category/<?php echo $row['banner'] ?>" width="100"></a></td> <?php } ?>
                                                ...
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        ...
                                                        <li><a href="subcategory-edit?id=<?php echo $row['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
