...
<head>
    ...
    <title><?php echo $_SESSION['user_type'] ?> - Delivery Area Add</title>
            ...
            <div class="layout-px-spacing">    
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3 class="float-left">Add Delivery Area</h3>
                    </div>
                </div>
                ...
                <div class="account-settings-container layout-top-spacing">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4 S5hPk" id="pincode" placeholder="Enter Pincode">
                                                                            <div class="LMNEu OT150 d-none"></div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                    ...
                    <div class="account-settings-footer">
                        ...
                        <div class="as-footer-container">
                            ...
                            <button id="add" class="btn btn-dark">Add Area</button>
                        </div>
